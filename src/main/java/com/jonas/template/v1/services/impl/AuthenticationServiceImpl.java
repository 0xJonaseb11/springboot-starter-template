package com.jonas.template.v1.services.impl;

import com.jonas.template.v1.dtos.request.auth.LoginDTO;
import com.jonas.template.v1.dtos.request.auth.RegisterUserDTO;
import com.jonas.template.v1.dtos.request.user.UserResponseDTO;
import com.jonas.template.v1.dtos.response.auth.AuthResponse;
import com.jonas.template.v1.enums.ERole;
import com.jonas.template.v1.enums.IEmailTemplate;
import com.jonas.template.v1.exceptions.AppException;
import com.jonas.template.v1.models.Role;
import com.jonas.template.v1.models.User;
import com.jonas.template.v1.repositories.IUserRepository;
import com.jonas.template.v1.security.jwt.JwtUtils;
import com.jonas.template.v1.security.user.UserPrincipal;
import com.jonas.template.v1.services.IAuthService;
import com.jonas.template.v1.services.IRoleService;
import com.jonas.template.v1.services.IUserService;
import com.jonas.template.v1.standalone.EmailService;
import com.jonas.template.v1.utils.Mapper;
import com.jonas.template.v1.utils.UserUtils;
