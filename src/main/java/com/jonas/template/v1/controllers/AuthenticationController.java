package com.jonas.template.v1.controllers;


import com.jonas.template.v1.dtos.request.auth.LoginDTO;
import com.jonas.template.v1.dtos.request.auth.PasswordResetDTO;
import com.jonas.template.v1.dtos.request.auth.PasswordUpdateDTO;
import com.jonas.template.v1.dtos.request.user.CreateAdminDTO;
...
public class AuthenticationController {
    ...
    private final IUserService userService;getLogger
    private static final Logger logger = LoggerFactory.(AuthenticationController.class);
